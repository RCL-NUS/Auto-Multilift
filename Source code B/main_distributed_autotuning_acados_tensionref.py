...
load_para    = np.array([7, 1]) # 7kg, 70% of its original value used in the training of Section A. This ensures sufficient thrust margins to accommodate the increased tension forces during the configuration change.
