...
def Evaluate():
    ...
    for k in range(N): 
        ...
        np.save('Evaluation results/Quad_State_closeloop_3quad',Quad_State)
        np.save('Evaluation results/Quad_Control_closeloop_3quad',Quad_Control)
        np.save('Evaluation results/Load_State_closeloop_3quad',Load_State)
        np.save('Evaluation results/Tension_Load_Actual_closeloop_3quad',Tension_Load_Actual)
        np.save('Evaluation results/Tension_Load_MPC_closeloop_3quad',Tension_Load_MPC)
        np.save('Evaluation results/TIME',TIME)
        np.save('Evaluation results/EULERl_closeloop_3quad',EULER_l)
        np.save('Evaluation results/Ref_Load_closeloop_3quad',Ref_Load)
        np.save('Evaluation results/Vl_closeloop_3quad',Vl)
    ...
    np.save('Evaluation results/Rmse_closeloop_3quad',rmse)
    ...
    plt.grid()
    plt.savefig('Evaluation results/cable_actual_tensions_fig8_closeloop_3quad.png',dpi=400)
    plt.show()
    ...
    plt.legend(['Cable0', 'Cable1', 'Cable2', 'Cable3'])
    plt.grid()
    plt.savefig('Evaluation results/cable_MPC_tensions_fig8_closeloop_3quad.png',dpi=400)
    plt.show()
    ...
    plt.grid()
    plt.savefig('Evaluation results/payload_attitude_MPC_fig8_closeloop_3quad.png',dpi=400)
    plt.show()
    ...
    ax2.grid()
    ax3.grid()
    plt.savefig('Evaluation results/payload_position_MPC_fig8_closeloop_3quad.png',dpi=400)
    plt.show()
    ...
    plt.ylabel('y [m]')
    plt.grid()
    plt.savefig('Evaluation results/payload_3D_MPC_fig8_closeloop_3quad.png',dpi=400)
    plt.show()
